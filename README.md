...
Sometimes schema of data layer can be really complex. Auto-resolving complex schema is memory and cpu consuming and in most
cases not sufficient enough. Storage framework was build to provide set of tools that help with the problem but not to 
resolve or overthink it for developer.
 
Custom (user-defined) hydrators are there to help you out with complex and problematic data schema you can decide
what and how things should be hydrated in your entities. 
