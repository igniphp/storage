...
- [Introduction](#introduction)
  * [Features](#features)
          + [Works with native queries](#works-with-native-queries)
          + [Small learning curve](#small-learning-curve)
          + [Support for multiple types of databases](#support-for-multiple-types-of-databases)
          + [Embed entities](#embed-entities)
          + [Cross database references](#cross-database-references)
          + [Support for declarative programming](#support-for-declarative-programming)
...
- [Mapping](#mapping)
  ...
  * [Entity](#entity)
      ...
      - [Types](#types)
      - [Date](#date)
        * [_Accepted attributes:_](#-accepted-attributes--)
      - [Decimal](#decimal)
        * [_Accepted attributes:_](#-accepted-attributes---1)
      - [Embed](#embed)
        * [_Accepted attributes:_](#-accepted-attributes---2)
      - [Enum](#enum)
        * [_Accepted attributes:_](#-accepted-attributes---3)
      - [Float](#float)
        * [_Accepted attributes:_](#-accepted-attributes---4)
      - [Id](#id)
        * [_Accepted attributes:_](#-accepted-attributes---5)
        * [Autogenerated ids](#autogenerated-ids)
      - [Integer](#integer)
        * [_Accepted attributes:_](#-accepted-attributes---6)
      - [Text](#text)
        * [_Accepted attributes:_](#-accepted-attributes---7)
      - [Reference](#reference)
        * [_Accepted attributes:_](#-accepted-attributes---8)
